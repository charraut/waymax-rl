...
from waymax_rl.simulator.observations import obs_global_with_target_eval
...
def eval_policy_one_episode(env, policy, key, action_size, idx, infer_model, render):
    ...
    if render:
        mediapy.write_video(
            "/home/ttournai/Workspace/DAR/waymax-rl/waymax_rl/evaluate/eval_scenarios/eval_" + str(idx) + ".mp4",
            imgs_ep,
            fps=10,
        )
